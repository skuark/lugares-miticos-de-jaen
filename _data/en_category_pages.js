import en_categories from './en_categories.json' with { type: 'json' };
    ...
    for (let i = 0; i < totalPages; i++) {
      pages.push({
        ...
        pagination: {
          ...
          href: {
            previous: i > 0 ? `/en/categories/${category.slug}${i === 1 ? '/' : `/page/${i}/`}` : null,
            next: i < totalPages - 1 ? `/en/categories/${category.slug}/page/${i + 2}/` : null
          }
        }
      });
    }
